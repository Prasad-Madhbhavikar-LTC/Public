...
from Core.Configurations import ConfigFactory, AbstractConfig

LOGGER = logging.getLogger(__name__)
class Migrator(object):
    def __init__(self, source_config_path: str, target_config_path: str, job_config_path: str):
        self.config: AbstractConfig = ConfigFactory.read_config(source_config_path, job_config_path, target_config_path)
